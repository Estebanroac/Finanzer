          ...
          <div className="rounded-2xl border border-white/[0.07] bg-[#0a0a0d]/85 px-5 sm:px-7 py-5 sm:py-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <a
                ...
                className="shrink-0 inline-flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium text-zinc-300 bg-white/[0.04] border border-white/[0.08] hover:bg-white/[0.08] active:scale-95 transition-all"
              >
