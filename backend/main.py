...
def _get_sector_benchmarks(sector: str) -> dict:
    ...
    sector_map = {
        ...
        "financial_services": {"pe": 13, "forward_pe": 11, "pb": 1.5, "roe": 0.12, "roa": 0.01, "de": 2.5, "net_margin": 0.25, "current_ratio": 0, "interest_coverage": 0},
        ...
        "communication_services": {"pe": 18, "forward_pe": 16, "pb": 3, "ev_ebitda": 10, "roe": 0.12, "net_margin": 0.12, "gross_margin": 0.55},
        ...
        "basic_materials": {"pe": 14, "forward_pe": 12, "pb": 2, "ev_ebitda": 8, "roe": 0.12, "net_margin": 0.08, "de": 0.6},
    }
    import re
