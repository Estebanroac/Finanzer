...
POPULAR_STOCKS = {
    ...
    "BNP": "BNP Paribas (OTC)",
    "SCGLY": "Société Générale ADR",
    "UNCRY": "UniCredit S.p.A. ADR",
    ...
    "PPRUY": "Kering S.A. ADR",
    "HESAY": "Hermès International ADR",
    "LRLCY": "L'Oréal S.A. ADR",
    "ADDYY": "adidas AG ADR",
    "PMMAF": "Porsche Automobil Holding",
    ...
    "SNEJF": "Sony Group (OTC)",
    "FUJIY": "FUJIFILM Holdings ADR",
    "CAJ": "Canon Inc.",
    "SNE": "Sony Group Corporation",
    "KYOCY": "Kyocera Corporation ADR",
    "MRAAY": "Murata Manufacturing ADR",
    "TOELY": "Tokyo Electron ADR",
    "FANUY": "FANUC Corporation ADR",
    "KNBWY": "Kobe Steel Ltd. ADR",
    "NPSNY": "Nippon Steel Corp. ADR",
    "PKDMF": "Panasonic Holdings",
    ...
    "PBR": "Petróleo Brasileiro (Petrobras)",
    "PBR-A": "Petróleo Brasileiro Pref",
    ...
    "EBR": "Centrais Elétricas Brasileiras",
    "BRFS": "BRF S.A.",
    "CBD": "Companhia Brasileira de Distr.",
    ...
    "AMX": "América Móvil S.A.B.",
    "CX": "Cemex S.A.B. de C.V.",
    "FMX": "Fomento Económico Mexicano",
    "GRFS": "Grifols S.A.",
    "BSMX": "Banco Santander México",
    "OMAB": "Grupo Aeroportuario Centro",
    "PAC": "Grupo Aeroportuario del Pacífico",
    "ASR": "Grupo Aeroportuario del Sureste",
    "TV": "Grupo Televisa S.A.B.",
    "LOMA": "Loma Negra Compañía",
    "IBA": "Industrias Bachoco S.A.B.",
    "WALMEX": "Walmart de México (BMV)",
    ...
    "STO": "Santos Limited",
    "ANZBY": "ANZ Bank ADR",
    "CBAUF": "Commonwealth Bank Australia",
    "WEBNF": "Westpac Banking Corp.",
    "NABZY": "National Australia Bank ADR",
    "MQBKY": "Macquarie Group ADR",
    "ATLKY": "Atlassian Corporation",
    ...
    "ANGPY": "Anglo American plc ADR",
    "NGLOY": "Anglo American Platinum ADR",
    "IMPUY": "Impala Platinum Holdings ADR",
    "SRGHY": "Sasol Limited ADR",
